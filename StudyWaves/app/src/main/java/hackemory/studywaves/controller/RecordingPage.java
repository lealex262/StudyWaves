...
public class RecordingPage extends AppCompatActivity implements OnClickListener{
     ...
     * hold the values of the last data packet received.
     *
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WeakReference<RecordingPage> weakActivity =
                new WeakReference<RecordingPage>(this);
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.refresh) {
            ...
            // This will stop data transmission and analyze the data log
            ...
            DialogInterface.OnClickListener buttonListener =
                    new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which){
                            dialog.dismiss();
                            ActivityCompat.requestPermissions(RecordingPage.this,
    ...
    */
    ...
    private void updateBeta() {
        TextView elem1 = (TextView)findViewById(R.id.belem1);
        elem1.setText(String.format("%6.2f", betaBuffer[0]));
        TextView elem2 = (TextView)findViewById(R.id.belem2);
        elem2.setText(String.format("%6.2f", betaBuffer[1]));
        TextView elem3 = (TextView)findViewById(R.id.belem3);
        elem3.setText(String.format("%6.2f", betaBuffer[2]));
        TextView elem4 = (TextView)findViewById(R.id.belem4);
    ...
    class MuseL extends MuseListener {
        final WeakReference<RecordingPage> activityRef;

        MuseL(final WeakReference<RecordingPage> activityRef) {
    ...
    class ConnectionListener extends MuseConnectionListener {
        ...
        ConnectionListener(final WeakReference<RecordingPage> activityRef) {
            this.activityRef = activityRef;
        }
    ...
    class DataListener extends MuseDataListener {
        ...
        DataListener(final WeakReference<RecordingPage> activityRef) {
            this.activityRef = activityRef;
        }
